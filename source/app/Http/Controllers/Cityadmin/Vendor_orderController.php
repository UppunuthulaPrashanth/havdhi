...
class Vendor_orderController extends Controller
{
    ...
    private $orders_user_id = 'orders.user_id';
    private $tbl_user_user_id = 'tbl_user.user_id';
    private $orders_address_id = 'orders.address_id';
    private $user_address_address_id = 'user_address.address_id';
    ...
    public function today_order1(Request $request)
        {
            ...
            if(Session::has('cityadmin'))
         {
        	...
        	// $vendor= DB::table('vendor')->where('cityadmin_id', $cityadmin->cityadmin_id)->get(); */
                ...
                $current2 = date('d-m-Y', strtotime($currentDate.' + '.$day.' days'));
    	         ...
    	         $vendor  =   DB::table('orders')
    	                    ->join('tbl_user', $this->orders_user_id, '=', $this->tbl_user_user_id)
    	                    ->join('user_address',$this->orders_address_id, '=', $this->user_address_address_id)
