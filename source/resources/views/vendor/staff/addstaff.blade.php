                ...
                <div class="card-body">
                  ...
                  <form class="forms-sample" action="{{route('AddNewstaff')}}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="exampleInputName1" name="staff_name" placeholder="Enter staff name">
                    </div>
                     <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="exampleInputName1" name="staff_description" placeholder="Enter staff description">
                    </div>
