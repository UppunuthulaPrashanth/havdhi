        ...
        <div class="box">
          ...
          <?php
                ...
                $base = $config['base_url'];
                 $base_url =str_replace("install/", "", $base);
...
fclose($myfile);
          ...
          <center>
            ...
            <p><strong>
              <?php
                ...
                $base = $config['base_url'];
              ?>
              <a href="<?php echo str_replace("install/", "", $base); ?>install_finish">Click Here to go</a>
            </strong></p><br>
          </center>
          <?php
          }
  ...
  <div class="content has-text-centered">
    <p>
      Made with ❤️ in India . All Rights Reserved. Powered by <a target="_blank" rel="noopener noreferrer" href="https://analogit.in/" >Analogit</a>.
    </p>
    <br>
  </div>
</body>
